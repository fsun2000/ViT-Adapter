...
_base_ = [
    '../_base_/models/mask2former_beit_scannet.py',
    '../_base_/datasets/s3dis.py',
    '../_base_/default_runtime.py',
    '../_base_/schedules/schedule_20k.py'
]
crop_size = (480, 480) # 896
...
pretrained = None
load_from = '/home/fsun/ViT-Adapter/segmentation/work_dirs/mask2former_beitv2_adapter_large_896_80k_scannet_ss_480p/iter_20000.pth'
model = dict(
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(int(448*4), 448), ratio_range=(0.5, 2.0)),
...
evaluation = dict(interval=10000, metric='mIoU', save_best='mIoU')  # 8000